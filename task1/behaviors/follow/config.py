...
# 系统参数
# =============================================================================
MAIN_LOOP_RATE = 12.5                # 主循环频率 (Hz)
LOG_LEVEL = "INFO"                 # 日志级别
VELOCITY_COMMAND_MIN_PERIOD = 0.07  # 底盘速度指令最小发送间隔 (s)
...
MAP_DIFF_THRESHOLD = 0.30          # 与静态地图差分的距离阈值 (m)
                                   # 小于此阈值的点认为是地图上的静态物体
# LiDAR候选与当前目标的空间关联参数
LIDAR_VISION_GATE_DISTANCE = 0.55      # 有当前视觉目标时，LiDAR候选到视觉目标的最大距离 (m) 现场如果误匹配，降到 0.4~0.45；如果经常匹配不到，升到 0.65。
LIDAR_EKF_GATE_DISTANCE = 0.8          # 无当前视觉目标时，LiDAR候选到EKF预测点的最大距离 (m)
LIDAR_COAST_GATE_MAX_DISTANCE = 1.5    # 目标短时丢失时，LiDAR关联门限最大放宽值 (m)
...
TARGET_PREDICTION_HORIZON = 0.2 # 预测时间 (s)


# =============================================================================
# 跟随控制参数
# =============================================================================
FOLLOW_DISTANCE =  0.5             # 目标跟随距离 (m)
