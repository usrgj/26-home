...
SEATS = [
    {"id": "seat_1", "occupied": None, "box1": [0, 0, 0, 0], "box2": [353,4,523,185]},  # box1 是在第一个观察位置看到的座位框，box2 是在第二个观察位置看到的座位框，如果某个位置看不到这个座位就设为 [0,0,0,0]
    {"id": "seat_2", "occupied": None, "box1": [0, 0, 0, 0], "box2": [112,174,334,328]},
    {"id": "seat_3", "occupied": None, "box1": [1,161,234,380], "box2": [0, 0, 0, 0]},
    {"id": "seat_4", "occupied": None, "box1": [421, 117, 603, 270], "box2": [0, 0, 0, 0]},
    {"id": "seat_5", "occupied": None, "box1": [233, 2, 371, 140], "box2": [0, 0, 0, 0]},
]
PRE_OCCUPIED_SEATS = []
HOST_SEATS = "seat_3"
